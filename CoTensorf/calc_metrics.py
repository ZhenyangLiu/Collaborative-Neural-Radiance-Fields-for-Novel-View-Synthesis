...
def parse_args():
    ...
    parser.add_argument("--gt", default="/home/guest/LZY/nerf-pytorch-master_avg/logs/nerf_avg_results/gt/chair_nerf_gt", help="Ground Truth 所在的文件夹")
    parser.add_argument("--r", default="/home/guest/LZY/conerf/TensoRF-main_tensor/log/log/tensorf_chair_VM/imgs_test_all", help="Rendered Views 所在的文件夹")
